...
class LengthUnmatch(ScoreException):
    ...
    def details(self):
        a = "Length Unmatched !"
        b = "gold sentence:" + unicode(self.len_gold_sentence)
        c = "test sentence:" + unicode(self.len_test_sentence)
        s = '\n'.join([a, b, c])
        s += '\n'
        s += '-'*30
        return s
...
class WordsUnmatch(ScoreException):
    ...
    def details(self):
        a = "Words Unmatched !"
        b = "gold sentence:" + unicode(self.gold_sentence)
        c = "test sentence:" + unicode(self.test_sentence)
        s = '\n'.join([a, b, c])
        s += '\n'
        s += '-'*30
        return s
